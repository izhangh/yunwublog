                    ...
                    <form class="form-horizontal" id="<?php echo GROUP_NAME; echo MODULE_NAME; echo ACTION_NAME;?>HandleForm" name="<?php echo GROUP_NAME; echo MODULE_NAME; echo ACTION_NAME;?>HandleForm" action="<?php echo U(GROUP_NAME.'/'.MODULE_NAME.'/handle');?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-13 text-center">
                                ...
                                <input type='hidden' name='content' id='content' value='<?php echo ($currdata["content"]); ?>' />
                                ...
                                <button type="submit" class="btn btn-success btn-lg" data-loading-text="正在提交..." autocomplete="off">提交</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<!-- ------------------being block------------------- -->
    ...
    <script>
        $(document).ready(function() {
            var mddata = <?php echo ($currdata['markdown']); ?>;
