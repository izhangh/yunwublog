        ...
        <div class="col-md-12 p15 p25">
            <div class="page-header clearfix">
                <h3 class="pull-left nomargin">
                    <a href="<?php echo U(GROUP_NAME.'/Channel/index');?>"><i class='fa fa-<?php echo ($_SESSION['curMenu']['icon']); ?>'></i><?php echo ($_SESSION['curMenu']['name']); ?></a> &#8260; <?php echo ($channel_data); ?>分类目录
                </h3>
            </div>
			<!-- search begin -->
            <div class="clearfix">
                <form class="form-horizontal" action="<?php echo U(GROUP_NAME.'/'.MODULE_NAME.'/'.ACTION_NAME);?>" method="get">
                    <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            $('#<?php echo GROUP_NAME; echo MODULE_NAME; echo ACTION_NAME;?>HandleForm').bootstrapValidator({
                ...
                if(ajaxReturnData.status == '200') {
                    ...
                    setTimeout(function() {
                    	window.location.replace("<?php echo U(GROUP_NAME.'/'.MODULE_NAME.'/'.ACTION_NAME, array('channel_id' => $channel_id));?>");
                    }, 1000);
